 ...
 * @author cbarca
 */
public class ArrhyRprop extends Rprop implements IClassifier {

    /**
     * Constructor for new Resilient Backpropagation network
     * @param network Rprop network 
     */
    public ArrhyRprop(RpropNetwork network) {
    	super(network);
    }
     ...
     */
    public ArrhyRprop(File file) throws IOException, 
