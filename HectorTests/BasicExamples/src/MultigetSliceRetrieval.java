...
public class MultigetSliceRetrieval {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < 20; i++) {
                mutator.addInsertion("fake_key_" + i, "Ex1cf1", HFactory.createStringColumn("fake_column_0", "fake_value_0_" + i))
                .addInsertion("fake_key_" + i, "Ex1cf1", HFactory.createStringColumn("fake_column_1", "fake_value_1_" + i))
                .addInsertion("fake_key_" + i, "Ex1cf1", HFactory.createStringColumn("fake_column_2", "fake_value_2_" + i));
            }
            ...
            multigetSliceQuery.setColumnFamily("Ex1cf1");
